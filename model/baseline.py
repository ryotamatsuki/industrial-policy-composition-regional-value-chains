"""Canonical baseline objects for IPCRVC-THEORY-FREEZE-2026-09-07-v1.

This module operationalizes the frozen theory. It must not be edited to introduce
new economics without reopening the required workflow stages.
"""
