...
\put(100,18){\framebox(50,12){\shortstack{Differentiated and symmetric NE coexist\\$A>A^N$}}}
...
<text x="170" y="112" text-anchor="middle" font-size="18">Both regimes duplicate</text><text x="420" y="103" text-anchor="middle" font-size="16">Unique decentralized duplication;</text><text x="420" y="123" text-anchor="middle" font-size="16">coordinated reallocation</text><text x="700" y="103" text-anchor="middle" font-size="16">Differentiated and symmetric NE coexist</text><text x="700" y="123" text-anchor="middle" font-size="16">for A &gt; A^N</text>
