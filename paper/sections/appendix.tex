...
Ignoring the constant $2b_D$, let
\[
\widetilde W(x_1,x_2)
=(\Delta+A)(x_1+x_2)-2Ax_1x_2.
\]
Because $\widetilde W$ is affine in each coordinate,
\begin{align*}
\widetilde W(x_1,x_2)
={}&(1-x_1)(1-x_2)\widetilde W(0,0)
+x_1(1-x_2)\widetilde W(1,0)\\
&+(1-x_1)x_2\widetilde W(0,1)
+x_1x_2\widetilde W(1,1).
\end{align*}
For feasible $(x_1,x_2)$, these four weights are nonnegative and sum to one. The corner values are
\[
\widetilde W(0,0)=0,
\qquad
...
\]
If $A<\Delta$, $2\Delta$ is the unique largest corner value, so equality with the maximum requires $x_1x_2=1$, hence $(x_1,x_2)=(1,1)$. If $A=\Delta$, the three corners $(1,0)$, $(0,1)$, and $(1,1)$ tie at the maximum; equality therefore holds exactly when $(1-x_1)(1-x_2)=0$, i.e. $x_1=1$ or $x_2=1$. If $A>\Delta$, only $(1,0)$ and $(0,1)$ attain the largest corner value. Equality then requires both $(1-x_1)(1-x_2)=0$ and $x_1x_2=0$, which yields exactly $(1,0)$ and $(0,1)$.
...
\lambda G-\Delta.
\]
The planner therefore strictly prefers to switch exactly when $G>\Delta$, while the local government strictly prefers to switch exactly when $G>\Delta/\lambda$. Thus
\[
G^P=\Delta,
\qquad
