...
Suppose $G$ is strictly increasing and both crossings exist:
\[
G(\tau^P)=\Delta,
\qquad
G(\tau^N)=\frac{\Delta}{\lambda}.
\]
Because $\Delta<\Delta/\lambda$, strict monotonicity implies $\tau^P<\tau^N$ and makes each crossing unique. Continuity with suitable range conditions is sufficient for crossing existence, but is not needed for the ordering once the crossings are given.
