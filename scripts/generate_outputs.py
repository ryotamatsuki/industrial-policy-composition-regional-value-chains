"""Generate deterministic manuscript exposition objects from frozen formulas."""
...
phase_tex = r'''% Auto-generated by scripts/generate_outputs.py. Do not edit by hand.
\begin{figure}[htbp]
\centering
...
# Retain a lightweight browser-readable SVG companion. It is illustrative only and
# is not the manuscript's quantitative source of truth.
...
manifest = {
    'freeze_id': FREEZE_ID,
    'generator': 'scripts/generate_outputs.py',
    'generated': [
        'tables/thresholds.tex',
        'figures/phase_regions.tex',
        'figures/phase_regions.svg',
    ],
    'note': 'Generated objects are exposition artifacts. Theorem validity is established by proofs, symbolic verification, and regression tests.'
}
(RESULTS / 'generated_manifest.json').write_text(json.dumps(manifest, indent=2) + '\n', encoding='utf-8')
print('Generated deterministic manuscript outputs')
